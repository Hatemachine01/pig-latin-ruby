class PigLatin
	...
	def self.translator(word)
		...
		#checks for words starting with QU and moves the vowels after uq to the beggining of the word,
		# and qu to the end of word + adds ay at the end
			...
			#If none of the conditions obove were true, the word must then start with a consosant 
